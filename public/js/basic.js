...
$.ajax({
    ...
    success: function(d){
            $('#reply').val('');
            $('.loader').hide();
            $('#reply_for'+e).append( '<div> <img width="30" height="30" src="'+d[1]['picture']+'">  <a href="/profile/'+d[1]['id']+' " > '+d[1]['name']+' </a> '+$('#reply_input'+e).val()+'<br> <span id="like" style="float:left; margin: 4px;" >  <i data-id="" onclick="likeComment(this,  )" style="float:left; margin: 4px;" class="fa heart fa-heart-o"></i> 0 </span>    </div> <br> <br>')
