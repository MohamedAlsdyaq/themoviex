...
<div id="create_group" style="padding-top: 1%;margin-bottom: 3%;" class="form-group  col-sm-8 col-xs-12 white_box" >
 ...
 <form enctype="multipart/form-data" action="/lists/create/store" method="post">
        {{ csrf_field() }} 
        ...
        <fieldset>
         ...
         <label for="smFormGroupInput" class="col-sm-2 col-form-label col-form-label-sm">List Picture:</label>
      <div class="col-sm-10">
  ...
  <span class="custom-file-control"></span>
      ...
      <div class="col-sm-10">
        <input name="name" type="text" class="form-control form-control-sm" id="smFormGroupInput" placeholder="Title of the group..">
          ...
          <br>  <br><br>  <br>
          <label for="smFormGroupInput" class="col-sm-2 col-form-label col-form-label-sm">Overview:</label>
      <div class="col-sm-10">
