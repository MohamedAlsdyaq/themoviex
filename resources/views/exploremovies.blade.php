...
<div style="padding: 2%" >
	<div style="float:left;width: 71%" >
        <h3 style="font-weight: bold;" >Explore Movies </h3>
 ...
 <div   style="display: none; z-index: 100" id="list2" class="  panel panel-default col-xs-12" style=":  ;">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class='row'>
                                <div class='col-md-12'>
                                    <div id="movies_results2" class=' media-middle'>
                                        <a href='#'>
...
<h4 style=" margin-bottom: %; font-weight: bold;" > Box Office </h4>
...
@endforeach()
<br>
<a href="/explore/movies/theaters" > <p style="float: right; margin: 1%" >see more </a>
</div>
<br>
...
@endforeach()
<br>
<a href="/explore/movies/top" > <p style="float: right; margin: 1%" >see more </a>
</div>
<br>
 ...
 <div style="width:100%; height: 300px;" >
<h4 style="   font-weight: bold;" > Upcoming </h4>
...
@endforeach()
<br>
<a href="/explore/movies/upcoming" > <p style="float: right; margin: 1%" >see more </a>
</div>
<br>
...
@endforeach()
<br>
<a href="/explore/movies/trending" > <p style="float: right; margin: 1%" >see more </a>
</div>
...
<hr style="margin: 2px" > 
 <div class="panel-body"> 
                ...
                <div class="col-sm-6">
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=28">Action </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=12">Adventure </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=16">Animation </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=35"> Comedy</a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=80"> Crime</a>
      <p class="text-center black" ><a class="black" href=" /search/movies?generes=9648"> Mystery</a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=99">Documentary </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=18">Drama </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=10751"> Family</a>
                </div>
                <div class="col-sm-6">
                              
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=14">Fantasy </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=36"> History</a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=10402"> Music </a>
      
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=878"> Sci-Fi</a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=10752"> War</a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=37">Western </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=53">Triller </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=27"> Horror </a>
                    <p class="text-center black" ><a class="black" href=" /search/movies?generes=1077"> TV Movie </a>
                </div>
